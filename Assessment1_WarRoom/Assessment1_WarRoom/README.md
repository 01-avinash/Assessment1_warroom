...
## What This Does
A multi-agent AI system that simulates a cross-functional "war room".
It reads 14 days of product metrics + 45 user feedback entries, then
5 agents collaborate to decide: **Proceed / Pause / Roll Back** a feature launch.
